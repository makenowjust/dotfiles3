...
fix-dir() {
  DOTFILES_FIX_DIR_FROM=("${DOTFILES_FIX_DIR_FROM[@]}" "$1")
  DOTFILES_FIX_DIR_TO=("${DOTFILES_FIX_DIR_TO[@]}" "$2")
}

fix-file() {
  DOTFILES_FIX_FILE_FROM=("${DOTFILES_FIX_FILE_FROM[@]}" "$1")
  DOTFILES_FIX_FILE_TO=("${DOTFILES_FIX_FILE_TO[@]}" "$2")
}
